...
from src.leakage_correction import run_leakage_correction
...
def main():
    ...
    # 3. Data leakage detection + Pipeline correction
    # Runs an incorrect workflow with FOUR layered leakage types (scaler,
    # imputer, encoder, SelectKBest fit on full dataset) and a correct
    # Pipeline workflow on the same train/test split, then compares.
    print("\n[Phase 3] Data Leakage Detection and Pipeline Correction")
